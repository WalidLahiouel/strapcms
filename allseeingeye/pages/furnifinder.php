...
echo '<p>This tool will scan Habbo\'s furni data file for furniture that is missing from our defs.</p><br />';
echo '<p><a href="http://habbo.com/gamedata/furnidata?hash=x">http://habbo.com/gamedata/furnidata?hash=x</a></p><br />';
...
$data = file_get_contents("http://habbo.com/gamedata/furnidata?hash=x");
$data = str_replace("\n", "", $data);
