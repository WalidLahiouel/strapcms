...
mysql_query("UPDATE users SET credits = credits + '200000' WHERE username = '$u'");
mysql_query("UPDATE users SET activity_points = activity_points + '200000' WHERE username = '$u'");
// gotta grab their id
