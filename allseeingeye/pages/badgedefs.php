...
echo '<h1>Badge defenitions (<b>ATTN:</b> Stop adding useless badges EG Pedobear</b>)</h1>';
...
while ($text = mysql_fetch_assoc($get))
{
	...
	echo '<td><img src="http://zaphotel.net/c_images/album1584/' . $badgeName . '.gif" style="vertical-align: middle;">&nbsp;&nbsp;' . $badgeName . '</td>';
