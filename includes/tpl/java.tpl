...
<script type="text/javascript">
    ...
    var flashvars = {
            ...
            "connection.info.host" : "69.162.114.98", 
            ...
            "client.connection.failed.url" : "http://disconnected.zaphotel.net/", 
            "external.variables.txt" : "http://zaphotel.net/gamedata/external_variables.txt", 
            "external.texts.txt" : "http://zaphotel.net/externals.php?id=external_flash_texts", 
            "productdata.load.url" : "http://zaphotel.net/gamedata/productdata.txt", 
            "furnidata.load.url" : "http://zaphotel.net/gamedata/furnidata.txt", 
            "use.sso.ticket" : "1", 
            "sso.ticket" : "asdf", 
    ...
    var params = {
        "base" : "http://zaphotel.net/gordon/RELEASE63-34096-33779-201105271559_8358af37d0a45b7e58dc35b0cd7fb90b/",
    ...
    var clientUrl = "http://zaphotel.net/gordon/RELEASE63-34096-33779-201105271559_8358af37d0a45b7e58dc35b0cd7fb90b/Java.swf";
