 ...
 <div style="display: block;">
  <div class="content-red">
   <div class="content-red-body">
    <span id="tag-limit-message"><img src="%web_gallery%/images/register/icon_error.gif"> ¡Has alcanzado el límite de 'YoSoys'! Elimina uno antes si quieres añadir otro nuevo.</span>
    <span id="tag-invalid-message"><img src="%web_gallery%/images/register/icon_error.gif"> 'YoSoy' no válido</span>
   </div>
  </div>
