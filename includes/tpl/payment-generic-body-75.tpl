...
$getPackages = dbquery('SELECT * FROM shells_packages WHERE id = "2"');
        ...
        <div id="payment-details">
            ...
            <div id="payment-methods" >
                ...
                <ul class="clearfix payment-methods-2">
                    ...
                    <li><a href="https://bitpay.com/cart/add?itemId=PLDbkypXaq_3LyYzQu7VzePYWx-d83MkaM0LxtrycVs=" onclick="return submitMethodForm($(this).up('form'), '19083', 'wp_paypal')" class="large-button logo-button"><span><b>Bitcoins</b></span><i></i></a></li>
