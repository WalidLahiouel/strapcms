...
Event.observe("widget-%id%-edit", "editButton:click", editButtonCallback); 
		...
		<span class="header-left">&nbsp;</span><span class="header-middle">Under maintenance</span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div> 
	<div class="widget-body"> 
		<div class="widget-content"> 
		<center>This widget is currently being worked on. </center>
		</div> 
	</div> 
</div> 
</div> 