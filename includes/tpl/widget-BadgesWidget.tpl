...
<div class="%skin%">
	<div class="widget-corner" id="widget-%id%-handle">
		<div class="widget-headline"><h3><span class="header-left">&nbsp;</span><span class="header-middle">Badges & Achievements</span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div>
	...
	{
	?>
            <li style="background-image: url(http://zaphotel.net/c_images/album1584/<?php echo $data['badge_id']; ?>.gif)"></li>
			<?php
			}//Termina while
	?>
    </ul>
