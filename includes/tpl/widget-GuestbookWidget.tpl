...
echo '<img src="http://images.zaphotel.net/%web_build%/web-gallery/images/myhabbo/icon_edit.gif" width="19" height="18" class="edit-button" id="widget-%id%-edit" />	
...
?>
<span class="header-left">&nbsp;</span><span class="header-middle">My Guestbook (<span id="guestbook-size"><?php echo $count; ?></span>) <span id="guestbook-type" class="private"><!--<img src="http://images.zaphotel.net/%web_build%/web-gallery/images/groups/status_exclusive.gif" title="Sólo amigos" alt="Sólo amigos">--></span></span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div>
...
<ul class="guestbook-entries" id="guestbook-entry-container">
	...
	<li id="guestbook-entry-'.$data['id'].'" class="guestbook-entry">
		<div class="guestbook-author">
                <img src="http://zaphotel.net/inc/imager.php?figure='.$users->GetUserVar($data['userid'], 'look').'&amp;size=s" alt="'.$users->GetUserVar($data['userid'], 'username').'" title="'.$users->GetUserVar($data['userid'], 'username').'" />
		</div>
			<div class="guestbook-actions">';
if(LOGGED_IN) { if(USER_ID == $qryId) {	echo '<img src="http://images.zaphotel.net/%web_build%/web-gallery/images/myhabbo/buttons/delete_entry_button.gif" id="gbentry-delete-'.$data['id'].'" class="gbentry-delete" style="cursor:pointer" alt="" /><br />'; } }
					echo '<img src="http://images.zaphotel.net/%web_build%/web-gallery/images/myhabbo/buttons/report_button.gif" id="gbentry-report-'.$data['id'].'" class="gbentry-report" style="cursor:pointer" alt="" />';
			echo '</div>
		...
		{
			echo 'You have no guestbook entries.';
		}
	?>
<div id="gb-progress" style="margin: 20px 0 60px 0; visibility: hidden">
	<div class="progressbar" style="">
		<img src="http://images.zaphotel.net/%web_build%/web-gallery/images/progress_bubbles.gif" width="29" height="6" alt="">
	</div>
</div>
</ul></div>
	...
	<b><span></span>Post a message</b><i></i>
	</a>
	</div>
	<?php
	}
