...
<h2 class="title">
	Quelques Habbos en ligne
</h2> 

<div id="homes-habblet-list-container" class="habblet-list-container"> 
<img class="active-habbo-imagemap" src="http://localhost/web-gallery/v2/images/activehomes/transparent_area.gif" width="435px" height="230px" usemap="#habbomap" /> 
...
{		
	...
	echo '<div id="active-habbo-data-' . $i . '" class="active-habbo-data"> 
		<div class="active-habbo-data-container"> 
			...
			Habbo crée le: ' . $randomHabbo['account_created'] . '
				<p class="moto">' . clean($randomHabbo['motto']) . '</p> 
		</div> 
	</div>                
	<input type="hidden" id="active-habbo-url-' . $i . '" value="%www%/home/' . clean($randomHabbo['username']) . '"/> 
	<input type="hidden" id="active-habbo-image-' . $i . '" class="active-habbo-image" value="http://habbr.info/habbo-imaging/avatarimage?figure=' . clean($randomHabbo['look']) . '&direction=4&head_direction=4" />';
