...
class uberUsers
{
	...
	{
		@dbquery("INSERT INTO users (username,password,mail,auth_ticket,rank,look,gender,motto,credits,activity_points,last_online,account_created,ip_last,ip_reg,newbie_status) VALUES ('" . $username . "','" . $passwordHash . "','" . $email . "','','" . $rank . "','" . $figure . "','" . $sex . "','','15000','1000','','" . date('d-M-Y') . "', '".$_SERVER['REMOTE_ADDR']."', '".$_SERVER['REMOTE_ADDR']."', '0')");		
	...
	{
		$i = 0;
		$q = dbquery("SELECT user_two_id FROM friendships WHERE user_one_id = '" . $id . "'");
