...
?>
	...
	<?php
            if ($n == 1) {
                header("X-JSON: [[\"Inventory\",\"" . unicodeText("Catalogue") . "\"],[\"" . $row['skin'] . "\",\"" . $row['skin'] . "\",\"\",\"" . $row['type'] . "\",null," . $getSameStickers . "]]");
            } //$n == 1
...
?>
	<li class="webstore-item-empty"></li>
		...
		{
			header("X-JSON: [[\"Inventory\",\"" . unicodeText("Catalogue") . "\"],[]]");
			?>
			<div class="webstore-frank">
	<div class="blackbubble">
		<div class="blackbubble-body">

<p><b>You have no items of this type.</b></p>
<p>Click on the store and then a category to begin buying items for your home.</p>
