...
Precio:<br /><b>
	<?php echo $row['price']; ?> credit<?php if($row['price'] > 1) { echo "s"; } ?>
...
<span class="webstore-preview-error">You don't have enough coins, bro!</span><br>
<a class="clearfix" webstore-preview-purchase="" href="http://zaphotel.net/credits">Credits page</a>
<?php } ?>

<a href="http://zaphotel.net/credits">Obtain coins</a>
</div>

<div id="webstore-preview-purchase" class="clearfix">
	<div class="clearfix">
		<a href="#" class="new-button <?php if($row['price'] > $myrow['credits']) { echo "disabled-button\" disabled=\"disabled"; } ?>" id="webstore-purchase"><b>Buy</b><i></i></a>
	</div>
</div>
